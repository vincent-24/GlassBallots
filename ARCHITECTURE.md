...
GlassBallots implements a robust, multi-layer architecture:

| Layer | Technology | Purpose |
|-------|------------|---------|
| UI | HTML/JS/CSS | User interaction |
| Frontend Server | Express.js | Static serving, routing |
| API | Express.js | Business logic, auth |
| Database | SQLite | Fast data storage |
| AI | Python/Flask/GPT-4o | Proposal analysis |
| Blockchain | Solidity/Hardhat | Immutable voting records |

This combination delivers:
- **Transparency**: All votes verifiable on-chain
- **Performance**: Instant dashboard loading from cache
- **Accessibility**: AI makes proposals understandable
